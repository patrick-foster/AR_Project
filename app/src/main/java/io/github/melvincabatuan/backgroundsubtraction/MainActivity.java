package io.github.melvincabatuan.backgroundsubtraction;
...
import android.graphics.Canvas; //Patrick added
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    //where the magic happens TODO: alter the preview frame by accessing the canvas and returning it to element
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        try{
            ...
            mCamera.setPreviewTexture(surface); // TODO: can be altered later so check
